...
var map = {
  "obstacles": [
    ...
    [ 880, 230, 10, 70, "red" ], // 14
    [ 810, 80, 10, 80, "red" ], // 15
    [ 740, 150, 70, 10, "red" ], // 16
    [ 670, 150, 70, 10, "red" ], // 17
    [ 810, 160, 10, 70, "red" ], // 18
    [ 740, 220, 70, 10, "red" ], // 19
    [ 670, 220, 70, 10, "red" ], // 20
    [ 600, 220, 70, 10, "red" ], // 21
    [ 600, 150, 10, 70, "red" ], // 22
    [ 530, 220, 70, 10, "red" ], // 23
    [ 530, 150, 10, 70, "red" ], // 24
    [ 600, 230, 10, 60, "red" ], // 25
    [ 810, 290, 70, 10, "red" ], // 26
    [ 740, 290, 70, 10, "red" ], // 27
    [ 670, 290, 70, 10, "red" ], // 28
    [ 600, 290, 70, 10, "red" ], // 29
    [ 530, 290, 70, 10, "red" ], // 30
    [ 470, 290, 60, 10, "red" ], // 31
    ...
    [ 880, 330, 10, 70, "red" ], // 11
    [ 880, 400, 10, 70, "red" ], // 12
    [ 880, 470, 10, 70, "red" ],// 13
    [ 880, 540, 10, 70, "red" ], // 14
    [ 810, 390, 10, 80, "red" ], // 15
    [ 740, 460, 70, 10, "red" ], // 16
    [ 670, 460, 70, 10, "red" ], // 17
    [ 810, 470, 10, 70, "red" ], // 18
    [ 740, 530, 70, 10, "red" ], // 19
    [ 670, 530, 70, 10, "red" ], // 20
    [ 600, 530, 70, 10, "red" ], // 21
    [ 600, 460, 10, 70, "red" ], // 22
    [ 530, 530, 70, 10, "red" ], // 23
    [ 530, 460, 10, 70, "red" ], // 24
    [ 600, 540, 10, 60, "red" ], // 25
    [ 810, 600, 70, 10, "red" ], // 26
    [ 740, 600, 70, 10, "red" ], // 27
    [ 670, 600, 70, 10, "red" ], // 28
    [ 600, 600, 70, 10, "red" ], // 29
    [ 530, 600, 70, 10, "red" ], // 30
    [ 470, 600, 60, 10, "red" ], // 31
    [ 460, 540, 10, 70, "red" ], // 32
    [ 460, 470, 10, 70, "red" ], // 33
    [ 460, 400, 10, 70, "red" ], // 34
    [ 460, 330, 10, 70, "red" ], //35
    ...
    [ 430, 400, 10, 70, "red" ], // 12
    [ 430, 470, 10, 70, "red" ],// 13
    [ 430, 540, 10, 70, "red" ], // 14
    [ 360, 390, 10, 80, "red" ], // 15
    [ 290, 460, 70, 10, "red" ], // 16
    [ 220, 460, 70, 10, "red" ], // 17
    [ 360, 470, 10, 70, "red" ], // 18
    [ 290, 530, 70, 10, "red" ], // 19
    [ 220, 530, 70, 10, "red" ], // 20
    [ 150, 530, 70, 10, "red" ], // 21
    [ 150, 460, 10, 70, "red" ], // 22
    [ 80, 530, 70, 10, "red" ], // 23
    [ 80, 460, 10, 70, "red" ], // 24
    [ 150, 540, 10, 60, "red" ], // 25
    [ 360, 600, 70, 10, "red" ], // 26
    [ 290, 600, 70, 10, "red" ], // 27
    [ 220, 600, 70, 10, "red" ], // 28
    [ 150, 600, 70, 10, "red" ], // 29
    [ 80, 600, 70, 10, "red" ], // 30
    [ 20, 600, 60, 10, "red" ], // 31
    [ 10, 540, 10, 70, "red" ], // 32
    [ 10, 470, 10, 70, "red" ], // 33
