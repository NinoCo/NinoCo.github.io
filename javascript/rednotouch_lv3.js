...
var map = {
  "obstacles": [
    ...
    [ 810, 290, 70, 10, "red" ], // 11
    [ 740, 290, 70, 10, "red" ],  // 12
    [ 670, 290, 70, 10, "red" ], // 13
    [ 670, 220, 10, 70, "red" ], // 14
    [ 600, 220, 70, 10, "red" ], // 15
    [ 530, 220, 70, 10, "red" ], // 16
    [ 600, 150, 10, 70, "red" ], // 17
    [ 600, 80, 10, 70, "red" ], // 18
    [ 530, 80, 70, 10, "red" ], // 19
    [ 750, 220, 70, 10, "red" ], // 20
    [ 810, 150, 10, 70, "red" ], // 21
    [ 740, 150, 70, 10, "red" ], // 22
    [ 740, 160, 10, 70, "red" ], // 23
    [ 740, 90, 10, 60, "red" ], // 24
    [ 670, 150, 70, 10, "red" ], // 25
    [ 670, 80, 10, 70, "red" ], // 26
    [ 680, 80, 70, 10, "red" ], // 27
    [ 600, 290, 70, 10, "red" ], // 28
    [ 530, 290, 70, 10, "red" ], // 29
    [ 460, 290, 70, 10, "red" ], // 30
    [ 460, 220, 10, 70, "red" ], // 31
    [ 460, 150, 10, 70, "red" ], // 32
    [ 470, 150, 70, 10, "red" ], // 33
    [ 460, 80, 10, 70, "red" ], // 34
    [ 460, 10, 10, 70, "red" ], // 35
    [ 470, 320, 70, 10, "red" ], // 1 bottom right
    [ 540, 320, 70, 10, "red" ], // 2
    [ 610, 320, 70, 10, "red" ], // 3
    [ 680, 320, 70, 10, "red" ], // 4
    [ 750, 320, 70, 10, "red" ], // 5
    ...
    [ 880, 400, 10, 70, "red" ], // 8
    [ 880, 470, 10, 70, "red" ], //9
    [ 880, 540, 10, 70, "red"], // 10
    [ 810, 600, 70, 10, "red" ], // 11
    [ 740, 600, 70, 10, "red" ],  // 12
    [ 670, 600, 70, 10, "red" ], // 13
    [ 670, 530, 10, 70, "red" ], // 14
    [ 600, 530, 70, 10, "red" ], // 15
    [ 530, 530, 70, 10, "red" ], // 16
    [ 600, 460, 10, 70, "red" ], // 17
    [ 600, 390, 10, 70, "red" ], // 18
    [ 530, 390, 70, 10, "red" ], // 19
    [ 750, 530, 70, 10, "red" ], // 20
    [ 810, 460, 10, 70, "red" ], // 21
    [ 740, 460, 70, 10, "red" ], // 22
    [ 740, 470, 10, 70, "red" ], // 23
    [ 740, 400, 10, 60, "red" ], // 24
    [ 670, 460, 70, 10, "red" ], // 25
    [ 670, 390, 10, 70, "red" ], // 26
    [ 680, 390, 70, 10, "red" ], // 27
    [ 600, 600, 70, 10, "red" ], // 28
    [ 530, 600, 70, 10, "red" ], // 29
    [ 460, 600, 70, 10, "red" ], // 30
    [ 460, 530, 10, 70, "red" ], // 31
    [ 460, 460, 10, 70, "red" ], // 32
    [ 470, 460, 70, 10, "red" ], // 33
    [ 460, 390, 10, 70, "red" ], // 34
    [ 460, 320, 10, 70, "red" ], // 35
    [ 20, 320, 70, 10, "red" ], // 1 bottom left
    [ 90, 320, 70, 10, "red" ], // 2
    [ 160, 320, 70, 10, "red" ], // 3
    [ 230, 320, 70, 10, "red" ], // 4
    [ 300, 320, 70, 10, "red" ], // 5
    ...
    [ 430, 400, 10, 70, "red" ], // 8
    [ 430, 470, 10, 70, "red" ], //9
    [ 430, 540, 10, 70, "red"], // 10
    [ 360, 600, 70, 10, "red" ], // 11
    [ 290, 600, 70, 10, "red" ],  // 12
    [ 220, 600, 70, 10, "red" ], // 13
    [ 220, 530, 10, 70, "red" ], // 14
    [ 150, 530, 70, 10, "red" ], // 15
    [ 80, 530, 70, 10, "red" ], // 16
    [ 150, 460, 10, 70, "red" ], // 17
    [ 150, 390, 10, 70, "red" ], // 18
    [ 80, 390, 70, 10, "red" ], // 19
    [ 300, 530, 70, 10, "red" ], // 20
    [ 360, 460, 10, 70, "red" ], // 21
    [ 290, 460, 70, 10, "red" ], // 22
    [ 290, 470, 10, 70, "red" ], // 23
    [ 290, 400, 10, 60, "red" ], // 24
    [ 220, 460, 70, 10, "red" ], // 25
    [ 220, 390, 10, 70, "red" ], // 26
    [ 230, 390, 70, 10, "red" ], // 27
